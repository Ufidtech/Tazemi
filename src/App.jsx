...
import { Operations, Aggregators, RnD, TruckAnalysis } from "./pages/dashboard/DashboardPages";
      ...
      <Routes>
        ...
        <Route path="*" element={
          <div className="min-h-screen flex items-center justify-center bg-deep text-white flex-col gap-4">
            ...
            <a href="/" className="bg-teal text-white px-6 py-3 rounded-lg font-semibold">Go Home</a>
          </div>
        }/>
      </Routes>
    </BrowserRouter>
